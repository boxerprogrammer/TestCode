...
namespace mgt_lib {
	...
	static Vector3 up_vec = { 0.0f,1.0f,0.0f };
	static Vector3 right_vec = { 1.0f,0.0f,0.0f };
	static Vector3 front_vec = { 0.0f,0.0f,1.0f };
	...
	const DxLib::VECTOR& VGetFromVector3(const Vector3& vec);
	const Vector3& GetVector3(const DxLib::VECTOR& vec);
